...
class SitePhilosophy extends HTMLElement {
  ...
  render() {
    const principles = [
      { idx: '01', title: '数据驱动', desc: '以全球国家与项目数据为基础，让每一次规划都有据可依。' },
      { idx: '02', title: '智能匹配', desc: '借助 AI 理解个人与家庭背景，匹配更适合的国际发展路线。' },
      { idx: '03', title: '全球视野', desc: '跨越地域与政策边界，为长期发展构建多元选择。' }
    ];
