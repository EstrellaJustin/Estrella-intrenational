...
- AI 模拟审核输出：申请条件匹配度（0–100）/ 材料完整度 / 风险等级（低/中/高）+ 优势 / 风险 / 建议 + DIY 准备路线（三阶段）
- 合规：不展示「保证通过/成功率100%/官方批准概率」；免责声明展示于 DIY 首页、提交审核按钮附近、AI 报告底部
- 材料真实性：材料基于官方公开通用要求，source_reference 引用各国官方移民/签证机构（项目 official_authority）
## 项目详情页 · 官方申请入口
