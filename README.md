...
- 页面：`travel.html`（区域分类首页）+ `travel-country.html?id=xx`（国家详情）
- 定位：全球旅行目的地探索（非廉价旅游网站，深蓝高级商务 + 国际旅行杂志质感）
- 数据库：`src/data/travel.json`（21 国 / 6 大洲：亚洲、欧洲、北美洲、南美洲、大洋洲、非洲）
- 国家详情：① 国家概览（简介/最佳季节/气候/语言/货币）② 热门城市 ③ 旅行信息（签证/时间/预算/交通/住宿）④ 特色体验（文化/自然景点/美食）⑤ 长期发展关联（留学/工作/长期居留项目，温和引导）
- 视觉：21 国高清主题图（本地资源 `assets/travel/`，离线可用）+ 深蓝蒙层 + 高级排版
